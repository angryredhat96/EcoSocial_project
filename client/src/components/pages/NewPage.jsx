      ...
      >
        <CardContent>
          ...
          >
            ...
            {/* <TextField value={inputs.date} onChange={changeHandler} inputFormat="MM/DD/YYYY" id="outlined-basic" name="date" label="Дата ивента " variant="outlined" /> */}
